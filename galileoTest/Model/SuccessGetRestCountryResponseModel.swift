//
//  SuccessGetRestCountryResponseModel.swift
//  galileoTest
//
...
//
//   let successGetRESTCountryResponseModel = try? newJSONDecoder().decode(SuccessGetRESTCountryResponseModel.self, from: jsonData)

import Foundation

// MARK: - SuccessGetRESTCountryResponseModelElement
struct SuccessGetRESTCountryResponseModelElement: Codable {
    let name: String?
...
typealias SuccessGetRESTCountryResponseModel = [SuccessGetRESTCountryResponseModelElement]
